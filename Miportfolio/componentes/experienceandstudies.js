export function estudiosexperiencia() {
  ...
  const estudiosLista = document.createElement("div");
  const estudios = [
    {
  ...
  for (const estudio of estudios) {
    const estudioContainer = document.createElement("div");
    const estudioTitulo = document.createElement("h4");
    ...
    estudioContainer.appendChild(estudioTitulo);
    estudioContainer.appendChild(estudioDescripcion);
    estudiosLista.appendChild(estudioContainer);
  }
